...
import WhatsappGroupCard from '@/features/whatsapp/components/WhatsappGroupCard/WhatsappGroupCard.vue';
...
/* Dialog Styles - Inspired by DonatePage */
.restriction-dialog {
